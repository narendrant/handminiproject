  ...
  <header>
      ...
      <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']): ?>
        <?php $_SESSION['rerror']='';
 if(getimagesize('images/profile_pics/'.$_SESSION['uid'].".png")!==false): ?><li><img style="height:50px;width:50px;"src=<?php echo "images/profile_pics/".$_SESSION['uid'].".png";?> class="circle propic" onerror="this.src='images/logo.png';"><?php else:?><li><img style="height:50px;width:50px;"src="images/sample-1.jpg" class="circle propic"><?php  endif;?></li><li style="padding-left:10px;"><?php echo $_SESSION["name"];?></li></li><li><a href="#" data-activates="drop" class="dropdown-button  dropdown-button1 disableClick"><i class="material-icons ">arrow_drop_down</i></a></li> 
	...
	<div class="card-panel col s10 offset-s1 m8 offset-m3" style="padding: 20px;">
				...
				<div class="row">
					...
					<div class="col m9 s11 input-field">
						<input  id="product_name" name="pname" type="text" class="validate" required>
						<label for="product_name">Product Name</label>
					</div>
				</div>
				<div class="row">
						<div class="file-field col m10 s12">
							<div class="btn">
				...
				<div class="row">
					...
					<div class="input-field col m9 s11">
						<textarea id="textarea1" name="alt_address" class="materialize-textarea"></textarea>
						<label for="textarea1">Alternate Address(Optional)</label>
					</div>
				</div>
				...
				<div class="row">
					<select class="col s9 offset-s1" name="category" required>
						<option value="Others"  selected>Choose Category</option>
						<option value="Electronics & Appliances">Electronics & Appliances</option>
						<option value="Furniture">Furniture</option>
						<option value="Bikes & Scooters">Bikes & Scooters</option>
						<option value="Power Tools">Power Tools</option>
						<option value="Musical Instruments">Musical Instruments</option>
						<option value="Baby Accessories & Toys">Baby Accessories & Toys</option>
				...
				<div class="row">
					...
					<div class="col s3 m2">
						<input placeholder="Daily Rent" name="drent" id="drent" type="number" class="validate" min="0" size="4">
					</div>
					...
					<div class="col s3 m2">
						<input placeholder="Weekly Rent" id="wrent" name="wrent" type="number" class="validate" min="0" size="4">
					</div>
				...
				<div class="row">
					...
					<label>
						No
						<input id="bond" name="bond" type="checkbox">
				...
				<div class="row hide-on-med-and-down">
					<div class="col s12 offset-s4">
								<button href="#submit" type='submit' class="waves-effect waves-light btn modal-trigger" >Submit</button>
					</div>
				</div>
				
				<div class="row hide-on-large-only">
					<div class="col s12 offset-s4">
								<a href="#submitmob" class="waves-effect waves-light btn modal-trigger" >Submit</a>
					</div>
				</div>
				</form>
      ...
      <button class="btn-flat waves-effect waves-darken modalButton terms" id="processingBut"><a href="#!" class="green-text text-darken-4"><i class="material-icons left">done</i>Agree</a></button> 
					...
					<div id="submitmob" class="modal hide-on-large-only" style="width:300px;">
					<div class="modal-content">
					
					<center style="padding-top: 30px;">
					  <div id='smallload' class="preloader-wrapper big active" >
						<div class="spinner-layer spinner-blue-only">
						  <div class="circle-clipper left">
							<div class="circle"></div>
						  </div><div class="gap-patch">
					  ...
					  <div class="row terms">
					    ...
					    <div class="modal-footer" id="modfooter1">
      <button class="btn-flat waves-effect waves-darken modal-close modalButton"><a href="#!" class=" red-text "><i class="material-icons left">not_interested</i> Disagree</a></button>
      <button class="btn-flat waves-effect waves-darken modalButton" id="processingBut"><a href="#!" class="green-text text-darken-4"><i class="material-icons left">done</i>Agree</a></button> 
    </div>
