...
<div class="collection with-header">
		...
		<ul class="collection-header"><h5>User options</h5></ul>
        <a href="#!" class="collection-item">View & Edit user</a>
        <a href="#!" class="collection-item">Email User</a>
 </div>
   </div>
</div>
