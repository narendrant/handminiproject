  ...
  <header>
      ...
      <a id="cat" href="#" class="brand-logo center"><?php echo "$cid"; ?></a>
 ...
 if(getimagesize('images/profile_pics/'.$_SESSION['uid'].".png")!==false): ?><li><img style="height:50px;width:50px;"src=<?php echo "images/profile_pics/".$_SESSION['uid'].".png";?> class="circle propic" onerror="this.src='images/logo.png';"><?php else:?><li><img style="height:50px;width:50px;"src="images/sample-1.jpg" class="circle propic"><?php  endif;?></li><li style="padding-left:10px;"><?php echo $_SESSION["name"];?></li></li><li><a href="#" data-activates="drop" class="dropdown-button  dropdown-button1 disableClick"><i class="material-icons ">arrow_drop_down</i></a></li> 
	  ...
	  <?php endif;?>
	   ...
	   <div class="row">
				...
				<a class='dropdown-button dropdown-button2 btn'  href='#' data-activates='dropdown1'><i  class="material-icons">my_location</i></a>
				</div>
	   ...
	   <?php
	   	...
	   	$sql = "SELECT product_ID,pname,price_day,price_week,price_month FROM Product WHERE category='$cid' ORDER BY rating DESC";
		...
		$price_week='';
		$price_month='';
		$stmt->bind_result($pid,$pname,$price_day,$price_week,$price_month);
		$flag=0;
		echo "<br><div class='row'>";
		echo "<div class='col m8 s10 offset-s1 offset-m3' style='font-size:220%;'></div></div></div><br><br>";
		while ($stmt->fetch()) {
		if ($flag==0) {
			echo "<div class='row'>";			
		...
		<?php } ?>
			 <div class='card small'>
				<div class='card-image waves-effect waves-block waves-light'>
					<?php if(getimagesize('images/products/1/'.$pid.".png")!==false): ?><img class='activator' src=<?php echo'images/products/1/'.$pid.".png";?> onerror=\"this.src='images/logo.png'\"><?php else:?><img src="images/logo.png"><?php endif;?>
