		...
		if ($flag==0) {
			...
			echo "<div class='card small'>
				...
				<div class='card-content'>
					<div  style='text-overflow:ellipsis;overflow:hidden;white-space:nowrap;'><span class='card-title activator grey-text text-darken-4'  >".$pname."<i class='material-icons left'>info_outline</i></span></div>
					<p><a href='product.php?pid=".$pid."'>Check Out Product</a></p>
				</div>
