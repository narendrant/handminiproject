						  ...
						  <ul class="collection with-header">
							...
							<?php
								...
								while($stmt->fetch() && $num_rows<5) {
									...
									<?php
								 if((getimagesize('images/profile_pics/'.$rid.".png")!==false)){
								 	?>
